...
import type { OverviewCardProps } from "../Overviewcard/Overviewcard";

export default function Overviewsection() {
  const initialCards: OverviewCardProps[] = [
    { id: 1,
      orderId: 1, 
  ...
  const widgetCards: OverviewCardProps[] = [
    { id: 8,
      orderId: 8,
  ...
  // Drag start
  const handleDragStart = (e: React.DragEvent<HTMLDivElement>, index: number, source: string) => {
  ...
  const handleDrop = (e: React.DragEvent<HTMLDivElement>, endIndex: number, target: string) => {
